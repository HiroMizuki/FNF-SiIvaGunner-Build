...
class ClientPrefs {
	...
	public static var sensitivityVisual:Bool = false;
	...
	public static function saveSettings() {
		...
		FlxG.save.data.sensitivityVisual = sensitivityVisual;
	...
	public static function loadPrefs() {
		...
		if(FlxG.save.data.sensitivityVisual != null) {
			sensitivityVisual = FlxG.save.data.sensitivityVisual;
		}
