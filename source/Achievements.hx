...
class Achievements {
	public static var achievementsStuff:Array<Dynamic> = [ //Name, Description, Achievement save tag, Hidden achievement
		...
		["She Calls Me Daddy Too",		"Beat Week 1.",										'week1',				false],
		["No More Tricks",				"Beat Week 2.",										'week2',				false],
		["Call Me The Hitman",			"Beat Week 3.",										'week3',				false],
		["Lady Killer",					"Beat Week 4.",										'week4',				false],
		["Missless Christmas",			"Beat Week 5.",										'week5',				false],
		["Highscore!!",					"Beat Week 6.",										'week6',				false],
		["God Effing Damn It!",			"Beat Week 7.",										'week7',				false],
